...
export default function Home() {
    ...
    const handleSelectApp = (app) => {
        if (app === "fec") {
            window.location.href = buildAppUrl(import.meta.env.VITE_FEC_URL || "http://localhost:5173");
        } else if (app === "test_utilization") {
            window.location.href = buildAppUrl(import.meta.env.VITE_TEST_UTILIZATION_URL || "http://localhost:5174");
        }
    };
